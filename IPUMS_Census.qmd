---
title: "Estimating U.S.-Wide PhD Numbers Using California Ratios"
subtitle: "Comparing Actual and Projected Data"
thanks: "Code is avalible at https://github.com/Veyasan1/US_Doctorates_Estimators.git"
...
In this paper we explore the US 2022 Census Data, sourced from IPUMS[@ipums2024] We use the programming language R[@citeR], along with packages readr[@readr], dplyr[@dplyr], and knitr[@xie2023knitr]
...
estimated_total <- doctorate_data %>%
  mutate(estimated_total_respondents = as.integer(doctoral_count / ratio))
